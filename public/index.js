...
biddingApp.directive('newAuction', function () {
  return {
    restrict: 'EA',
...
biddingApp.directive('liveAuctions', function () {
  return {
    restrict: 'EA',
    templateUrl: '/templates/liveAuctions'
    // link: function (scope, iElement, iAttrs) {
      
    // }
  };
})
biddingApp.directive('closedAuctions', function () {
  return {
    restrict: 'EA',
